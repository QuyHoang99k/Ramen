    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>{{ $blogpost->post_title_vn }}</li>
            </ul>
            ...
            <div class="blog-page">
                <div class="col-md-9">
                    <div class="blog-post wow fadeInUp">
                        ...
                        <p>
                            @if (session()->get('language') == 'japan')
                                {!! $blogpost->post_details_ja !!}
                            @else
                                {!! $blogpost->post_details_vn !!}
                            @endif
                        </p>
                        <!-- Go to www.addthis.com/dashboard to customize your tools -->
                        <div class="addthis_inline_share_toolbox_8tvu"></div>
                ...
                <div class="col-md-3 sidebar">
                    <div class="sidebar-module-container">
                        ...
                        <div class="home-banner outer-top-n outer-bottom-xs">
                            <img style="width: 250px;height:200px" src="{{ asset('frontend/assets/images/banners/LHS-banner.jpg') }}" alt="Image">
                        </div>
                        <!-- ======== ====CATEGORY======= === -->
                                        ...
                                        <ul class="list-group">
                                            <a href="{{ url('blog/category/post/' . $category->id) }}">
                                                <li class="list-group-item">
                                                    @if (session()->get('language') == 'japan')
                                                        {{ $category->blog_category_name_ja }}
                                                    @else
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-61a33f874dee873e"></script>
@endsection
