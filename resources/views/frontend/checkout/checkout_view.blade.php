                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            <h4 class="checkout-subtitle"><b>Địa chỉ nhận hàng</b></h4>
                                            ...
                                            <form class="register-form" action="{{ route('checkout.store') }}"
                                                ...
                                                <div class="form-group">
                                                    <label class="info-title" for="exampleInputEmail1"><b>Số Điện Thoại</b>
                                                        <span>*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label class="info-title" for="exampleInputEmail1"><b>Mã Bưu Điện
                                                        </b> <span>*</span></label>
                                        ...
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            ...
                                            <div class="form-group">
                                                <h5><b>Lựa chọn đơn vị vận chuyển </b> <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <h5><b>Tỉnh Thành</b> <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="exampleInputEmail1">Ghi chú
                                                    <span>*</span></label>
                        ...
                        <div class="panel-group">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="unicase-checkout-title">Sản Phẩm Thanh Toán</h4>
                                </div>
                                <div class="">
                                    <ul class="nav nav-checkout-progress list-unstyled">
                                        ...
                                        <li>
                                            @if (Session::has('coupon'))
                                                <strong>Tổng Tiền: </strong> {{ number_format($cartTotal) }}円
                                                <hr>
                                                ...
                                                {{ number_format(session()->get('coupon')['discount_amount']) }}円
                                                <hr>

                                                <strong>Tổng Tiền Thanh Toán : </strong>
                                                {{ number_format(session()->get('coupon')['total_amount']) }}円
                                                <hr>
                                            @else
                                                <strong>Tổng Tiền Thanh Toán: </strong> {{ number_format($cartTotal) }}円
                                                <hr>

                                                <strong>Số Tiền Phải Trả : </strong> {{ number_format($cartTotal) }}円
                                                <hr>
                                            @endif
