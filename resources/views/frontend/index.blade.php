                        ...
                        <nav class="yamm megamenu-horizontal">
                            <ul class="nav">
                                @foreach ($categories as $category)
                                    <li class="dropdown menu-item"> <a style="text-transform:capitalize" href="#"
                                                ...
                                                <div class="row">
                                                    ...
                                                    @foreach ($subcategories as $subcategory)
                                                        <div class="col-sm-12 col-md-3">
                                                            <h2 class="title">
                                                                @if (session()->get('language') == 'japan')
                                                                {{ $subcategory->subcategory_name_ja }} @else
                                                            ...
                                                            @foreach ($subsubcategories as $subsubcategory)
                                                                <ul class="links">
                                                                    <li><a style="text-transform:capitalize" href="#">
                                                                            @if (session()->get('language') == 'japan')
                                                ...
                                                <div class="products">
                                                    <div class="product">
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a
                                                                    style="text-transform: capitalize" href="detail.html">
                                                                    @if (session()->get('language') == 'japan')
                                                            ...
                                                            </span> <span class="price-before-discount"> {{ number_format($product->selling_price) }}円</span>
                                                        </div>
                                                            @endif
                                ...
                                <div class="tab-pane in " id="category{{ $category->id }}">
                                    <div class="product-slider">
                                        <div class="owl-carousel home-owl-carousel custom-carousel owl-theme"
                                            ...
                                            @empty
                                                <h5 class="text-danger">Sản Phẩm Đang Được Cập Nhật</h5>
                                            @endforelse
                                            <!-- /.item -->
                                        </div>
                                        <!-- /.home-owl-carousel -->
