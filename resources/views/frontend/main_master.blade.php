        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button id="cloaseModel" type="button" class="close" data-dismiss="modal"
                        aria-label="Close">
                        ...
                        <div class="col-md-4">
                            <ul class="list-group">
                                <li class="list-group-item">Product Price: <strong class="text-danger"><span
                                            id="pprice"></span>円</strong>
                                    <del id="oldprice">円</del>
                                </li>
                                ...
                                <li class="list-group-item">Stock: <span class="badge badge-pill badge-success"
                                        ...
                                        style="background: red; color: white></span><strong id=" aviable" "></strong></li>
                            </ul>
                        </div>
                        <div class="                     col-md-4">
                        ...
                        miniCart += `<div class="cart-item product-summary">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-7">
                                            ...
                                            <div class="price">${value.price}円 * ${value.qty}</div>
                                        </div>
                ...
                success: function(response) {
                   ...
                   <td class="col-md-7">
                       ...
                       ${value.product.discount_price == null
                           ?　 `${value.product.selling_price}円`
                           :
                           `${value.product.discount_price}円<span>${value.product.selling_price}円</span>`
                       }
    ...
    <script type="text/javascript">
       ...
       <input type="text" value="${value.qty}" min="1" max="100" disabled="" style="width:25px;" >
        ...
        <button type="submit" class="btn btn-success btn-sm" id="${value.rowId}" onclick="cartIncrement(this.id)" >+</button>
            ...
            <td class="col-md-2">
           <strong>${value.subtotal} 円</strong>
           </td>
                    ...
                    if (data.total) {
                            ...
                            ` <tr>
                                        <th>
                                            <div class="cart-sub-total">
                                                Tổng Tiền: <span class="inner-left-md">${data.total}円</span>
                                            </div>
                                            <div class="cart-grand-total">
                                                Tổng tiền phải trả: <span class="inner-left-md">${data.total}円</span>
                                            </div>
                                        </th>
                                    </tr>`
                        )
                        ...
                        $('#couponCalField').html(
                            ` <tr>
                                        <th>
                                            <div class="cart-sub-total">
                                                Tổng Tiền: <span class="inner-left-md">${data.subtotal}円</span>
                                            </div>
                                            <div class="cart-sub-total">
                                            ...
                                            <div class="cart-sub-total">
                                                Số tiền được giảm: <span class="inner-left-md">${data.discount_amount} 円</span>
                                            </div>
                                            <div class="cart-grand-total">
                                                Tổng còn phải trả: <span class="inner-left-md">${data.total_amount} 円</span>
                                            </div>
                                        </th>
                                    </tr>`
                        )
