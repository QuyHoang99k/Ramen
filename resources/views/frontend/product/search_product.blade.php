...
<style>
    ...
    @if($products -> isEmpty())
    <h3 class="text-center text-danger">Sản Phẩm Không Tồn Tại </h3>
    ...
    <div class="container mt-5">
       ...
       <div class="d-flex flex-column ml-3" style="margin-left: 10px;"> <span>{{ $item->product_name_en }} </span> <small> {{ number_format($item->selling_price) }}円</small> </div>
                    </div>
                    </a>
                    @endforeach
