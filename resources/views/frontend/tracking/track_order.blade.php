...
<div class="container">
    <article class="card">
        <header class="card-header"> <b> Tình Trạng Đơn Hàng </b> </header>
        <div class="card-body">
            ...
            <div class="track">
                ...
                @if ($track->status == 'pending')
                    ...
                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span>
                        <span class="text"> Đã xác nhận</span> </div>
                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span>
                        <span class="text">Đang vận chuyển </span> </div>
                    <div class="step"> <span class="icon"> <i class="fa fa-check"></i> </span>
                        <span class="text">Giao hàng thành công  </span> </div>
